...
public class HalftoneParticleGenerator extends
		AbstractUniformParticleGenerator<HalftoneParticle> {
	...
	@Override
	protected HalftoneParticle forPoly(Path path, RenderData renderData,
		...
		return new HalftoneParticle(threshold, new BlendedColor(bgref));
	}
}
