...
public class JToggleButtonEx extends JToggleButton {
	...
	public JToggleButtonEx(int displayType) {
		this(null, displayType);
	}

	public JToggleButtonEx(String text, int displayType) {
		this(text, null, null, displayType);
	}

	public JToggleButtonEx(Icon smallIcon, Icon largeIcon, int displayType) {
		this(null, smallIcon, largeIcon, displayType);
	}

	public JToggleButtonEx(String text, Icon smallIcon, Icon largeIcon,
			int displayType) {
		this.text = text;
