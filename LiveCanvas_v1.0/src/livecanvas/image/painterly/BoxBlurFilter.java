...
public class BoxBlurFilter extends AbstractBufferedImageOp {
	@FloatType(name = "Horizontal Radius", description = "Horizontal radius of the blur", min = 0, max = 100, step = 1)
	public float hRadius;

	@FloatType(name = "Vertical Radius", description = "Vertical radius of the blur", min = 0, max = 100, step = 1)
	public float vRadius;

	@IntegerType(name = "Iterations", description = "The number of times to iterate the blur", min = 1, max = 10, step = 1)
	public int iterations = 1;

	@BooleanType(name = "Premultiply Alpha", description = "Whether to premultiply the alpha channel or not")
